package com.oksenenko.soundrecorder;
...
import com.oksenenko.soundrecorder.listeners.OnDBChangesListener;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static OnDBChangesListener mOnDBChangesListener;
    ...
    public static void setOnDatabaseChangedListener(OnDBChangesListener listener) {
        mOnDBChangesListener = listener;
    }
    ...
    public long addRecording(String recordingName, String filePath, long length) {
        ...
        if (mOnDBChangesListener != null) {
            mOnDBChangesListener.onNewDatabaseEntryAdded();
        }
    ...
    public void renameItem(RecordingItem item, String recordingName, String filePath) {
        ...
        if (mOnDBChangesListener != null) {
            mOnDBChangesListener.onDatabaseEntryRenamed();
        }
    }
